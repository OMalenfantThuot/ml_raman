#The source code comes from se.spectrum.dosdata with the only modification of enabling Lorentzian smearing
    ...
    def _sample(self,
        ...
        Args:
            ...
            smearing: selection of broadening kernel (only "Gauss" is currently
                supported. NEW : Lorentzian smearing was added. Default is "Gauss".)
